export default function Projects() {
	return (
		<div className='flex flex-wrap w-[auto] md:w-[1200px] m-auto justify-center gap-4 mt-10'>
			<div class='flex flex-col gap-y-4 max-w-sm h-auto bg-white border border-gray-200 rounded-lg shadow py-4 px-[10px]'>
			...
			<div class='max-w-sm bg-white border border-gray-200 rounded-lg shadow'>
				...
				<div class='p-5'>
					<img src='https://user-images.githubusercontent.com/57721146/177380891-25e00068-216b-4feb-bc41-d1e71ad0f2db.gif' />
				</div>
			</div>
